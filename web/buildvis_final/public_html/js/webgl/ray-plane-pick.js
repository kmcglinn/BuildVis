...
var g_intersection_point_wor = undefined;
var g_intersection_distance = undefined;
...
function get_mouse_ray_wor (mouse_x, mouse_y) {
	...
	var canvas = document.getElementById ("canvas_id"); // get canvas using DOM
...
/*! tests a ray (defined as a world origin and a direction vector)
		against a plane (defined as a facing direction and a 1D offset along this
		facing from world origin),
		returns true if hit,
		and then updates the g_intersection_point_wor variable */
