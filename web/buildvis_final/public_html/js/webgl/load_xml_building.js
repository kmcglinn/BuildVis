...
var g_walls_json_url = "cad_xml/pica.json";
...
function _create_walls_from_xml (url) {
...
//                console.log(wall_load_divisor);
            
            var x1 = -x[i].getElementsByTagName ("x1")[0].childNodes[0].nodeValue/wall_load_divisor + wall_load_modifier_x; //(perimeters[0][1]/zone_load_divisor)+zone_load_modifier_y)
            var y1 = x[i].getElementsByTagName ("y1")[0].childNodes[0].nodeValue/wall_load_divisor + wall_load_modifier_y;
            var x2 = -x[i].getElementsByTagName ("x2")[0].childNodes[0].nodeValue/wall_load_divisor + wall_load_modifier_x;
            var y2 = x[i].getElementsByTagName ("y2")[0].childNodes[0].nodeValue/wall_load_divisor + wall_load_modifier_y;
		
            if((x1<boundary&&x1>-boundary)&&(y1<boundary&&y1>-boundary)&&(x2<boundary&&x2>-boundary)&&(y2<boundary&&y2>-boundary))
            {
		// first triangle
	...
	for (var i = 0; i < x.length; i++) {
            ...
            var x1 = -x[i].getElementsByTagName ("x2")[0].childNodes[0].nodeValue/wall_load_divisor + wall_load_modifier_x; //(perimeters[0][1]/zone_load_divisor)+zone_load_modifier_y)
            var y1 = x[i].getElementsByTagName ("y2")[0].childNodes[0].nodeValue/wall_load_divisor + wall_load_modifier_y;
            var x2 = -x[i].getElementsByTagName ("x1")[0].childNodes[0].nodeValue/wall_load_divisor + wall_load_modifier_x;
            var y2 = x[i].getElementsByTagName ("y1")[0].childNodes[0].nodeValue/wall_load_divisor + wall_load_modifier_y;
